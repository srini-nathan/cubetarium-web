					...
					<div className="col-12">
						...
						<div className="divTable">
							<div className="divTableBody">
								...
								<div className="divTableRow">
									<div className="divTableCell">10000</div>
									<div className="divTableCell">
										50.0 &nbsp;AVAX
									</div>
								</div>
					...
					<div className="col-12 cube-info">
						<label>
							<p>
								...
								These are limited by 10.000 and all are 512x512
								Models. Sugarcubes are created by an algorithm
								and all of them will be stored on the
								Inter-Planetary File System (IPFS). Sugarcubes
								are on the Avalanche C-Chain Network.
							</p>
							<p>
								There are several Sugarcubes such as Human
								(Commons), Non-Humans (Rares), Rubiks (Epics)
