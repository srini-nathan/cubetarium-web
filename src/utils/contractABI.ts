...
const Contract_ABI = [
		...
		inputs: [
			{
				indexed: false,
				internalType: 'uint256[]',
				name: '_mintedIndicies',
				type: 'uint256[]',
			},
		],
		name: 'ReturnMintedIndicies',
		type: 'event',
	},
	{
		anonymous: false,
	...
	},
	{
		...
		outputs: [
			...
			{
				internalType: 'enum ERC721.CubeState',
				name: 'state',
				type: 'uint8',
			},
		],
